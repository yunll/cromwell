...
object ObsStorageObjectAttributesSpec extends MockitoSugar{
...
class ObsStorageObjectAttributesSpec extends TestKitSuite with ObsNioUtilSpec {

  behavior of s"ObsStorageObjectAttributes"
  ...
  "an obs object attr" should "be an right" in {
    val attr = new ObsStorageObjectAttributes(getObjectMeta, getObject)
  ...
  "an obs directory attr" should "be an right" in {
    val attr = new ObsStorageDirectoryAttributes(getDir)
